...
function kseal(){
	ns=bale-bank
	echo "Encrypting $1 in namespace $ns"
 kubectl -n $ns create secret generic --from-literal a=$1 --dry-run=client -o yaml a | kubeseal --scope namespace-wide | jq '.spec.encryptedData.a'
}
